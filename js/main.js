...
(function () {
  ...
  /* -----------------------------------------------------
     Modal genérico reutilizable: abre/cierra un overlay,
     gestiona foco y Escape. Se usa tanto para el modal de
     Discord (servidor/usuario) como el de Instalar
     (plataformas).
     ----------------------------------------------------- */
  function initModal(overlayId, closeBtnId, triggerSelector) {
